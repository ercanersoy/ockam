...
function(ockam_cc_library)
  ...
  if(NOT _RULE_TESTONLY OR OCKAM_BUILD_TESTS)
    ...
    if(NOT _RULE_IS_INTERFACE)
      ...
      if(_RULE_PUBLIC_HDRS)
        set_target_properties(${_NAME} PROPERTIES
          PUBLIC_HEADER ${_RULE_PUBLIC_HDRS})
      endif()
    ...
    if(_RULE_PUBLIC_HDRS_DIR)
      set(PUBLIC_HEADER_OUTPUT_DIRECTORY "${OCKAM_INCLUDES_OUTPUT_DIRECTORY}/${_RULE_PUBLIC_HDRS_DIR}")
    else()
      set(PUBLIC_HEADER_OUTPUT_DIRECTORY "${OCKAM_INCLUDES_OUTPUT_DIRECTORY}")
    endif()
